    ...
    <body>
        <%
            try {
                ...
                String html = "";
                html += "<table class='table text-nowrap table-bordered  table-sm text-center w-100' id='table_order'>";
                html += "<thead>";
                html += "<tr>";
                html += "<th class='p-0'>ลำดับ</th>";
                html += "<th class='p-0'>เลขที่คำสั้งซื้อ</th>";
                ...
                for (OUUploadOrder orderdetail : listorder) {
                    ...
                    html += "<td class='p-0'><b>รหัสพนักงาน : </b>" + orderdetail.getOrder_cms_id() + "      ||    <b>ชื่อนามสกุล : </b>" + orderdetail.getOrder_cms_fullname() + "<br><b>บริษัท : </b>" + orderdetail.getOrder_cms_company() + "   ||  <b>เเผนก : </b>" + orderdetail.getOrder_cms_department() + "</td>";
                ...
                html += "<tfoot>";
                html += "<tr>";
                html += "<td colspan='7' class='p-0 text-center'><b>รวม</b></td>";
                    ...
                    drawCallback: function (settings) {
                        ...
                        .each(function (group, i) {
                            if (last !== group) {
                                $(rows)
                                .eq(i)
                                .before('<tr class="group"><td colspan="13" class="text-center" >' + group + '</td></tr>');
